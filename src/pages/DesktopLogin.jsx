  ...
  export default function DesktopLogin() {
    ...
    return (
      <div className="relative bg-white/10 backdrop-blur-md rounded-2xl window-shadow border border-white/20 w-[900px] h-[600px] flex flex-col overflow-hidden">      <div
